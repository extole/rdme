...
let
  sources = {
    ...
    "oas-1.2.0" = {
      ...
      version = "1.2.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/oas/-/oas-1.2.0.tgz";
        sha512 = "PyxCYG9nGOOPKTpBw2BaqIRl15f7y5IiR0EPpiA7ig7DewI/sJgBiJhEqXd4cqySbuwgY62OW4IfFd6HiQj5xw==";
      };
    };
    "oas-normalize-0.1.1" = {
      name = "oas-normalize";
      ...
      version = "0.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/oas-normalize/-/oas-normalize-0.1.1.tgz";
        sha512 = "pB37dVgioRlvJFdFn0sHKLKi6tBhdrYzz3hmgSm614KfKJOG0rKqEDtR2hbbzXkRfghBWwErIKPpgAtGKNG4hw==";
      };
    };
    "oauth-sign-0.9.0" = {
      name = "oauth-sign";
